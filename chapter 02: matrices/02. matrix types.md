...
- A **Hermitian matrix** is the complex equivalent of a symmetric matrix: $A = A^*$ (where $A^*$ is the conjugate transpose). 
...
- A **unitary matrix** is the complex equivalent of an orthogonal matrix: $U^*U = UU^* = I$. Just as orthogonal matrices preserve lengths in real spaces, unitary matrices preserve lengths in complex spaces.
